...
export default function ProductFilters({ activeFilters, onFilterChange }: ProductFiltersProps) {
  ...
  const gammes = [
    ...
    { value: 'Elegance', label: { fr: 'Élégance', de: 'Eleganz', en: 'Elegance' }, count: 12 },
    { value: 'Rustic', label: { fr: 'Rustique', de: 'Rustikal', en: 'Rustic' }, count: 8 },
    { value: 'Country', label: { fr: 'Country', de: 'Country', en: 'Country' }, count: 1 },
  ];
