    ...
    <main className="min-h-screen bg-natura-50">
      ...
      <section className="py-24 px-6 mt-20">
        <div className="max-w-2xl mx-auto text-center">
          {/* Icon */}
          <div className="w-20 h-20 bg-gradient-to-br from-amber-800 to-amber-900 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg">
          ...
          <p className="text-natura-600 text-lg mb-8">
            {labels.subtitle[locale]}
          </p>

          {/* Stats */}
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 shadow-sm mb-8 border border-amber-100">
            ...
            <div className="grid grid-cols-2 gap-4 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-natura-700">{labels.allProducts[locale]} ({products.length})</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-natura-700">{labels.dimensions[locale]}</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-natura-700">{labels.prices[locale]}</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-natura-700">{labels.finishes[locale]}</span>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className={`inline-flex items-center gap-3 px-8 py-4 rounded-xl font-semibold text-lg transition-all ${
              isGenerating
                ? 'bg-natura-200 text-natura-500 cursor-wait'
                : 'bg-gradient-to-r from-amber-700 to-amber-800 text-white hover:from-amber-800 hover:to-amber-900 shadow-lg hover:shadow-xl'
            }`}
          >
            {isGenerating ? (
              <>
          ...
          {/* Progress bar */}
          {isGenerating && (
            <div className="mt-6 w-full bg-amber-100 rounded-full h-2 overflow-hidden">
              <div 
          ...
          <div className="mt-12">
            <Link 
              ...
              className="text-natura-600 hover:text-natura-900 transition-colors"
            >
